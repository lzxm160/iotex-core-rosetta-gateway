...
./rosetta-cli check --lookup-balance-by-block=false --bootstrap-balances ./bootstrap_balances.json --exempt-accounts ./exempt_accounts_mainnet.json --data-dir=./data --log-balance-changes=true --log-reconciliations=true --block-concurrency 4
